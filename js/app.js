...
TweenMax.to(".vert", 0.5, {width:"600px", onComplete: function(){
    ...
    TweenMax.to(".jaune", 0.5, {width:"500px", onComplete: function(){
        ...
        TweenMax.to(".pink", 0.5, {width:"500px", onComplete: function(){
            
            
            
            
                TweenMax.to(".maskTxt", 0.8, { width:"550px", onComplete:function(){
    
    
    TweenMax.to(".black", 0.4, { width:0});
    TweenMax.to(".GostTristan", 0.5, { width:"700px", delay:0.4});
